...
interface LyricsRepository {
    suspend fun getLyrics(track: Track, durationSec: Int? = null, forceRefresh: Boolean = false): LyricsResult
    suspend fun refreshLyrics(track: Track, durationSec: Int? = null): LyricsResult
